...
```json
{
  ...
  "anniversary": "1985-01-25", // Also matches fields named `Married on`, `Marriage date`, `Wedding date`, `Date of wedding`, `Date of marriage`, `Anniversary date`, `Wedding anniversary date`, and `Marriage anniversary date` (case-insensitive)
...
| anniversary   | Date of person's anniversary in ISO format _`YYYY-MM-DD`_<br/>_Also matches fields named `Married on`, `Marriage date`, `Wedding date`, `Date of wedding`, `Date of marriage`, `Anniversary date`, `Wedding anniversary date`, and `Marriage anniversary date` (case-insensitive)_          | `undefined` |
